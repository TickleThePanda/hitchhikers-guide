var DEFAULT_TEXT = "Don't Panic!";
var DEFAULT_TEXT_SIZE = "10vw";
...
function resizeText() {
    $("#text-container").css("font-size", DEFAULT_TEXT_SIZE);
    
    while ($("#text-container").outerHeight() > $("#main-container").innerHeight()) {
        var currentFontSize = $("#text-container").css("font-size");
        $("#text-container").css("font-size", (parseFloat(currentFontSize) - 1) + "px");
    }
}
...
function setText(newText) {
    if (newText) {
        ...
        $("#text-container").css("-webkit-text-stroke-width", "0px");
    } else {
        $("#text-container").text(DEFAULT_TEXT);
        $("#text-container").css("-webkit-text-stroke-width", "3px");
    }

    resizeText();
}

var status = "dontpanic";
